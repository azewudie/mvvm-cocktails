...
class CocktailAdapter(private  val searchDetails: (String) ->Unit):ListAdapter<CocktailItem,CocktailAdapter.CocktailViewHolder>(CocktailItemDiffUtil){


    class CocktailViewHolder(private val binding: CocktailItemLayoutBinding)
        : RecyclerView.ViewHolder(binding.root){
            fun onBind(dataItem : CocktailItem, showDetails:(String) ->Unit){
                binding.tvSearchDrinkTag.text = dataItem.strTags
                binding.tvSearchDrinkName.text = dataItem.strDrink
